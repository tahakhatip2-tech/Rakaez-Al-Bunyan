import { z } from 'zod';
import { insertProjectSchema, insertServiceSchema, insertArticleSchema, insertReviewSchema, insertPartnerSchema, projects, services, articles, reviews, partners } from './schema.js';
